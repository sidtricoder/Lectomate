            ...
            >
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">support@lectomate.com</p>
                      <p className="text-gray-600">hello@lectomate.com</p>
                    </div>
                  </div>
              ...
              <div className="card">
                ...
                <div className="flex space-x-4">
                  <button
                    onClick={() => window.open('https://twitter.com/lectomate', '_blank')}
                  ...
                  <button
                    onClick={() => window.open('https://linkedin.com/company/lectomate', '_blank')}
                  ...
                  <button
                    onClick={() => window.open('https://pinterest.com/lectomate', '_blank')}
              ...
              <div className="card">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-2">How quickly do you respond to inquiries?</h3>
                    <p className="text-gray-600 text-sm">We typically respond within 24 hours during business days.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-2">Do you offer technical support?</h3>
                    <p className="text-gray-600 text-sm">Yes! Our technical support team is available to help with any issues.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-2">Can I schedule a demo?</h3>
                    <p className="text-gray-600 text-sm">Absolutely! Contact us to schedule a personalized demo.</p>
                  </div>
                </div>
              </div>
            </motion.div>
